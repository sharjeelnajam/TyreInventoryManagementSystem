...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260507054029_AddDisplayProductName")]
    partial class AddDisplayProductName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Customer", b =>
                {
                    ...
                    b.Property<Guid>("ListManagementId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.CustomerSalerPrice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.ListManagement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Product", b =>
                {
                    ...
                    b.Property<string>("Min_Threshold")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Sale", b =>
                {
                    ...
                    b.Property<Guid?>("ShopServiceBillId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.ShopServiceBill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ShopServiceBills");
                });

            modelBuilder.Entity("Domain.ShopServiceBillItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ShopServiceBillId");

                    b.HasIndex("TenantId");

                    b.ToTable("ShopServiceBillItems");
                });
            ...
            modelBuilder.Entity("Domain.ShopServiceBillItem", b =>
                {
                    b.HasOne("Domain.ShopServiceBill", "ShopServiceBill")
                        .WithMany("Items")
                        .HasForeignKey("ShopServiceBillId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
